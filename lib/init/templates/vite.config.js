...
function docsAssetsPlugin() {
    const sourceEntry = path.resolve(import.meta.dirname, 'src/index.js');
    const sourceFile = path.resolve(import.meta.dirname, `dist/${ID}.esm.js`);
    const targetFile = path.resolve(import.meta.dirname, `docs/assets/${ID}.esm.js`);
    return {
        name: 'docs-assets',
        enforce: 'pre',
        buildStart() {
