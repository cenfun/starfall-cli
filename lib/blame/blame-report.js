...
const initColumnGroup = function(g) {
    ...
    return {
        ...
        subs: [{
            ...
            align: 'right',
            type: 'percent',
            classMap: 'tg-cell-mask bg-gray',
            headerClassMap: 'bg-gray'
        }, {
            id: GID(id, 'comments'),
            name: 'Comments',
            width: 88,
            ...
            align: 'right',
            type: 'number',
            classMap: 'border-right',
            headerClassMap: 'border-right'
        }, {
            id: GID(id, 'days'),
            name: 'Days',
            align: 'right',
    ...
    Util.CG({
        options: {
            defaultFormatter: function(v, row, column) {
                ...
                if (column.type === 'percent' && typeof v === 'number') {
                    return Util.PF(v);
                }
                return v;
            }
...
const createBlameInfo = function(report) {
    ...
    const authorAlias = {
        ... conf.authorAlias,
        ... Util.getConfig('blame.authorAlias')
    };
    conf.authorAlias = {};
...
const reportHandler = async (report) => {
    ...
    // Util.writeJSONSync(jsonPath, info);
