...
const copyPreviewFiles = async (item, fromPath, previewPath, packPath) => {
    console.log("Copy component preview files ...");
    shelljs.cp("-R", `${fromPath}/${previewPath}`, packPath);

    //remove preview src folder
    const previewSrc = `${packPath}/${previewPath}/src`;
...
const copyBuildFiles = (item, fromPath, buildPath, previewPath) => {
...
const packComponent = async (componentName) => {
    ...
    item.componentPath = `${packPath}/${previewPath}/`;
    ...
    await copyPreviewFiles(item, fromPath, previewPath, packPath);
    ...
    //====================================================================================
    //copy build files
    await copyBuildFiles(item, fromPath, buildPath, previewPath);
