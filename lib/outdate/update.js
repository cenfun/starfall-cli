...
import {
    getAscKeyObject, writeJSONSync, getProjectConf, isList, readJSONSync, getComponentList, getComponentFullName, getComponentPath
} from '../core/util.js';
...
const updateModule = async () => {
    ...
    list.forEach(function(itemName) {
        const fullName = getComponentFullName(itemName);
        ...
        const p = `${getComponentPath(itemName)}/package.json`;
        const json = readJSONSync(p);
        packages.push({
            internal: true,
            name: json.name,
