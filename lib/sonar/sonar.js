...
const sonarModule = (p) => {
    ...
    if (Util.componentsRoot) {
        ...
        components.forEach(function(name) {
            const specsPath = `${Util.root}/${packagesPath}/${name}/test/specs`;
        ...
        list.forEach(function(name) {
            ...
            lines.push(`${name}.sonar.sources=${packagesPath}/${name}/src`);
            lines.push(`${name}.sonar.tests=${packagesPath}/${name}/test/specs`);
