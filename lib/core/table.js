...
const TableModule = {
    ...
    getOption: (option, dataOption) => {
        ...
        return mergeOption(defaultOption, option, dataOption);
    },
    ...
    getCellStyle: (styleCell, column, row) => {
        ...
        return TableModule.getStyleAttr.apply(TableModule, args);
    },
    ...
    generateBarChart: (tests, passed, failed) => {
