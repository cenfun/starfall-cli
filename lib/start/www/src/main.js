...
Main.prototype = {
    ...
    updateBuildButton: function() {
        const productionChecked = $('.cb-production').get(0).checked;
        let production = '';
        ...
        const buildCmd = `${ID} build ${this.getSelectedNames()}${production}${bundle}`;
        $('.cli-build').attr('tooltip', buildCmd);
        const buildAllCmd = `${ID} build${production}${bundle}`;
    ...
    updatePreCommitButton: function() {
        ...
        const precommitCmd = `${ID} precommit ${this.getSelectedNames()}${pass}${production}`;
        $('.cli-precommit').attr('tooltip', precommitCmd);

        const precommitAllCmd = `${ID} precommit${pass}${production}`;
    ...
    initGrid: function() {
        ...
        this.grid.bind('onSelectChanged', function(e, d) {
            self.updateSelected();
    ...
    showContextMenu: function(d) {
        ...
        this.grid.setRowSelected(false);
    ...
    showList: function(list) {
        ...
        this.grid.onNextUpdated(function() {
    ...
    bindEvents: function() {
        ...
        $('.cb-production').unbind().bind('change', function() {
